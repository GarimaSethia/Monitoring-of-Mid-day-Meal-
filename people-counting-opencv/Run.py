...
firebase = firebase.FirebaseApplication('https://fir-python-dc15c.firebaseio.com/', None)
...
ap.add_argument("-in", "--input", type=str, help="path to optional input video file")
...
ap.add_argument("-nm", "--modelc", required = True, help = "path to model")
...
result = firebase.post('https://fir-python-dc15c.firebaseio.com/', {'ID':str(ID), 'Date':str(date), 'People':int(total), 'Food':str(l)})
...
url = "file://home/gaurav/SiH/testdata.html"
